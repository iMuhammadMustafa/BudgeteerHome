...
const BudgetCalculator = () => {
  ...
  useEffect(() => {
    if (income && expenses) {
      ...
      if (monthlyExpenses > monthlyIncome * 0.7) {
        newSuggestions.push("Consider reducing dining out by 30% to save $" + Math.round(monthlyExpenses * 0.15 * 0.3));
      }
      if (current < savingsGoal) {
        const needed = savingsGoal - current;
        newSuggestions.push("Cut subscription services to reach your goal faster (+$" + Math.round(needed * 0.4) + "/month)");
      }
      if (monthlyIncome > 0) {
        newSuggestions.push("Automate transfers to save " + Math.round((potential / monthlyIncome) * 100) + "% of your income");
      }
  ...
  const potentialRate = income ? (potentialSavings / parseFloat(income)) * 100 : 0;
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            See how much you could save with smarter budgeting. Get personalized insights in seconds.
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                <TooltipProvider>
                  <div className="space-y-2">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Label htmlFor="income" className="cursor-help">Monthly Income</Label>
                      </TooltipTrigger>
                      <TooltipContent>
                        <p>Your total after-tax monthly income from all sources</p>
                      </TooltipContent>
                    </Tooltip>
                    <Input
                      id="income"
                  ...
                  <div className="space-y-2">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Label htmlFor="expenses" className="cursor-help">Monthly Expenses</Label>
                      </TooltipTrigger>
                      <TooltipContent>
                        <p>Total monthly spending including rent, food, utilities, and entertainment</p>
                      </TooltipContent>
                    </Tooltip>
                    <Input
                      id="expenses"
                  ...
                  <div className="space-y-2">
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Label htmlFor="goal" className="cursor-help">Savings Goal</Label>
                      </TooltipTrigger>
                      <TooltipContent>
              ...
              <CardContent className="space-y-6">
                {income && expenses ? (
                  <>
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-sm text-muted-foreground">
                        {savingsRate.toFixed(1)}% of income • {goalProgress.toFixed(0)}% of goal
                      </p>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Progress value={Math.min(potentialRate * 2, 100)} className="h-3" />
                      <p className="text-sm text-muted-foreground">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-2">
                          {suggestions.map((suggestion, index) => (
                            <div key={index} className="text-sm p-3 bg-primary/5 rounded-lg border border-primary/10">
                              {suggestion}
                            </div>
                          ))}
                        </div>
                    ...
                    <div className="pt-4 border-t">
                      ...
                      <p className="text-xs text-muted-foreground text-center mt-2">
                        See detailed breakdowns and get personalized budgeting tips
                      </p>
                    </div>
                  </>
                ) : (
                  <div className="text-center py-8 text-muted-foreground">
                    ...
                    <p>Enter your financial details to see your savings potential</p>
                  </div>
                )}
              </CardContent>
            </Card>
